    ...
    <div className="mb-4 rounded-md border border-border bg-surface">
      ...
      >
        <span className="flex items-center gap-2">
          <span className="font-display text-sm text-ink">Búsqueda con IA</span>
              ...
              <ul className="divide-y divide-border overflow-hidden rounded-md border border-border">
                {resultados.map((resultado) => (
                  <li
                    ...
                    className="flex items-center justify-between gap-3 px-4 py-3 text-sm hover:bg-surface-muted/60"
                  >
